...
{phang}
List supported: indexes, cryptocurrency markets, cryptocurrencies, and commodities

{p 8 32 2}
{cmd:aavantage list} {it:index}|{it:market}|{it:crypto}|{it:commodity}
...
{pstd}
{cmd:aavantage list} displays supported indexes, cryptocurrency markets, cryptocurrencies, and commodities
codes.
